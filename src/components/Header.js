import LOGO_URL from "../images/HungryHeaven-logo.png";
  ...
  return (
    <div className="header">
      <div className="logo-container">
        <Link to="/">
          <img className="logo" src={LOGO_URL} alt="HungryHeaven" />{" "}
        </Link>
        <div className="location-container" onClick={openSidepanel}>
          <span className="location-title">
            <span className="location-subtitle">{address.length>0 ? address[0].main_text:'Select'}</span>
          </span>
          <span className="location-address">
          {address.length>0?address[0].secondary_text:'Location'}
          </span>
